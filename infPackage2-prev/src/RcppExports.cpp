...
RcppExport SEXP _infPackage2_EMAlgorithmAll(SEXP em_methodSEXP, SEXP probability_methodSEXP, SEXP maximum_iterationsSEXP, SEXP stopping_thresholdSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _infPackage2_EMAlgorithmCDF(SEXP probability_methodSEXP, SEXP maximum_iterationsSEXP, SEXP stopping_thresholdSEXP, SEXP verboseSEXP, SEXP multivariate_methodSEXP, SEXP multivariate_epsilonSEXP, SEXP multivariate_iterationsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::String >::type probability_method(probability_methodSEXP);
...
RcppExport SEXP _infPackage2_EMAlgorithmHitAndRun(SEXP probability_methodSEXP, SEXP maximum_iterationsSEXP, SEXP stopping_thresholdSEXP, SEXP verboseSEXP, SEXP step_sizeSEXP, SEXP samplesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::String >::type probability_method(probability_methodSEXP);
...
RcppExport SEXP _infPackage2_RprecomputeHR(SEXP samplesSEXP, SEXP step_sizeSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::IntegerVector >::type samples(samplesSEXP);
    Rcpp::traits::input_parameter< Rcpp::IntegerVector >::type step_size(step_sizeSEXP);
...
RcppExport SEXP _infPackage2_RprecomputeExact() {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    RprecomputeExact();
    return R_NilValue;
...
RcppExport SEXP _infPackage2_RsetParameters(SEXP candidate_matrixSEXP, SEXP group_matrixSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _infPackage2_clean_exact_precompute() {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    clean_exact_precompute();
    return R_NilValue;
...
RcppExport SEXP _infPackage2_clean_hr_precompute() {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    clean_hr_precompute();
    return R_NilValue;
...
RcppExport SEXP _infPackage2_clean_everything() {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    clean_everything();
    return R_NilValue;
...
static const R_CallMethodDef CallEntries[] = {
    {"_infPackage2_EMAlgorithmAll", (DL_FUNC) &_infPackage2_EMAlgorithmAll, 5},
    {"_infPackage2_EMAlgorithmCDF", (DL_FUNC) &_infPackage2_EMAlgorithmCDF, 7},
    {"_infPackage2_EMAlgorithmHitAndRun", (DL_FUNC) &_infPackage2_EMAlgorithmHitAndRun, 6},
    {"_infPackage2_RprecomputeHR", (DL_FUNC) &_infPackage2_RprecomputeHR, 2},
    {"_infPackage2_RprecomputeExact", (DL_FUNC) &_infPackage2_RprecomputeExact, 0},
    {"_infPackage2_RsetParameters", (DL_FUNC) &_infPackage2_RsetParameters, 2},
    {"_infPackage2_clean_exact_precompute", (DL_FUNC) &_infPackage2_clean_exact_precompute, 0},
    {"_infPackage2_clean_hr_precompute", (DL_FUNC) &_infPackage2_clean_hr_precompute, 0},
    {"_infPackage2_clean_everything", (DL_FUNC) &_infPackage2_clean_everything, 0},
    {NULL, NULL, 0}
};

RcppExport void R_init_infPackage2(DllInfo *dll) {
