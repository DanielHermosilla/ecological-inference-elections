...
EMAlgorithmAll <- function(em_method, probability_method, maximum_iterations, stopping_threshold, verbose) {
    .Call('_eimodel_EMAlgorithmAll', PACKAGE = 'eimodel', em_method, probability_method, maximum_iterations, stopping_threshold, verbose)
}
...
EMAlgorithmCDF <- function(probability_method, maximum_iterations, stopping_threshold, verbose, multivariate_method, multivariate_epsilon, multivariate_iterations) {
    .Call('_eimodel_EMAlgorithmCDF', PACKAGE = 'eimodel', probability_method, maximum_iterations, stopping_threshold, verbose, multivariate_method, multivariate_epsilon, multivariate_iterations)
}

EMAlgorithmHitAndRun <- function(probability_method, maximum_iterations, stopping_threshold, verbose, step_size, samples) {
    .Call('_eimodel_EMAlgorithmHitAndRun', PACKAGE = 'eimodel', probability_method, maximum_iterations, stopping_threshold, verbose, step_size, samples)
}
