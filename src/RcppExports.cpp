...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(EMAlgorithmFull(candidate_matrix, group_matrix, em_method, probability_method, maximum_iterations, maximum_seconds, stopping_threshold, log_stopping_threshold, verbose, step_size, samples, monte_method, monte_error, monte_iter, metropolis_iter, burn_in, miniterations));
...
RcppExport SEXP _fastei_bootstrapAlg(SEXP candidate_matrixSEXP, SEXP group_matrixSEXP, SEXP nbootSEXP, SEXP em_methodSEXP, SEXP probability_methodSEXP, SEXP maximum_iterationsSEXP, SEXP maximum_secondsSEXP, SEXP stopping_thresholdSEXP, SEXP log_stopping_thresholdSEXP, SEXP verboseSEXP, SEXP step_sizeSEXP, SEXP samplesSEXP, SEXP monte_methodSEXP, SEXP monte_errorSEXP, SEXP monte_iterSEXP, SEXP metropolis_iterSEXP, SEXP burn_inSEXP, SEXP miniterationsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type candidate_matrix(candidate_matrixSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::IntegerVector >::type burn_in(burn_inSEXP);
    Rcpp::traits::input_parameter< Rcpp::IntegerVector >::type miniterations(miniterationsSEXP);
    rcpp_result_gen = Rcpp::wrap(bootstrapAlg(candidate_matrix, group_matrix, nboot, em_method, probability_method, maximum_iterations, maximum_seconds, stopping_threshold, log_stopping_threshold, verbose, step_size, samples, monte_method, monte_error, monte_iter, metropolis_iter, burn_in, miniterations));
    return rcpp_result_gen;
END_RCPP
}
// groupAgg
...
static const R_CallMethodDef CallEntries[] = {
    {"_fastei_EMAlgorithmFull", (DL_FUNC) &_fastei_EMAlgorithmFull, 17},
    {"_fastei_bootstrapAlg", (DL_FUNC) &_fastei_bootstrapAlg, 18},
    {"_fastei_groupAgg", (DL_FUNC) &_fastei_groupAgg, 21},
    {"_fastei_groupAggGreedy", (DL_FUNC) &_fastei_groupAggGreedy, 20},
    {NULL, NULL, 0}
};
