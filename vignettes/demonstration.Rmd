...
plot_matrix <- function(mat) {
    ...
    df$text_color <- ifelse(df$Value > 50, "black", "white")
...
```{r, eim_sim3_heatmap, fig.width = 8, fig.height = 6.5, fig.cap = "Voters' heatmap for a low lambda value", fig.align = "center", message=FALSE, warning=FALSE, results="hide"}
eim_sim3 <- simulate_election(
    num_ballots = 10, num_groups = 2, num_candidates = 2, seed = 42,
    lambda = 0.1
)
...
```{r, eim_sim4_heatmap, fig.width = 8, fig.height = 6.5, fig.cap = "Voters' heatmap for a high lambda value", fig.align = "center", message=FALSE, warning=FALSE, results="hide"}
