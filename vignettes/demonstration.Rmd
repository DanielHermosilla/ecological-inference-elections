...
```{r, echo=FALSE, fig.align='center', out.width='60%', fig.cap="Log-likelihood performance among different electoral districts"}
knitr::include_graphics("img/logComparison.png")
```

However, there's a trade-off between the log-likelihood and standard deviation.

```{r, echo=FALSE, fig.align='center', out.width='60%', fig.cap="Trade-off between log-likelihood and standard deviations"}
